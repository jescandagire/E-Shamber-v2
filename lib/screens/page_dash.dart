...
import 'package:eshamberv2/widgets/widgets.dart';
import 'package:eshamberv2/utils/utils.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'dart:io';

import 'package:flutter/foundation.dart';
import 'package:eshamberv2/screens/page_investor_groups.dart';
import 'package:eshamberv2/screens/farm_list.dart';
import 'package:eshamberv2/screens/farm_detail2.dart';
...
class _DashPageState extends State<DashPage> {
  ...
  Widget upperPart(String username) {   //*******why use the variable "username", where has it been used******
    return Stack(
      children: <Widget>[
        ClipPath(
...
//*****  *****
  ...
  //***** building routes for the tiles when tapped *****

  Route _navigateToMyFarmPageRoute(){

    return PageRouteBuilder(
//      pageBuilder: (context, animation, secondaryAnimation) => MyFarmPage(),
//      pageBuilder: (context, animation, secondaryAnimation) => FarmTile(),
